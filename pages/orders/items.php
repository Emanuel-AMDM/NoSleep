...
require_once('../../services/orders/list_entity_orders_items.php');
require_once('../../services/orders/get_by_id_nav_cart.php');
require_once('../../services/orders/get_by_id.php');

$orders = list_entity_orders_items($id_order);
